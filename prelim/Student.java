...
public class Student {
    ...
    public boolean equals(Student other) {
        boolean r = false;
        r = (firstName.equalsIgnoreCase(other.getFirstName())&&midName.equalsIgnoreCase
                (other.getMidName())&&lastName.equalsIgnoreCase(other.getLastName())); /*You may improve this
part */
        return r;
    }
